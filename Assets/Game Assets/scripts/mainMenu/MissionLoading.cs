...
public class MissionLoading : MonoBehaviour {
	...
	IEnumerator Start () {
		...
		SceneManager.LoadSceneAsync("RangerWars");
	}
	...
	void Update () 
	{
		...
		SmoothFollowTrans sF = (SmoothFollowTrans)Camera.main.GetComponent(typeof(SmoothFollowTrans));
